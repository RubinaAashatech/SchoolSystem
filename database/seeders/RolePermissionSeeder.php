    ...
    //define permission for School Teacher
        $permissionForTeacher = [
            ...
            'delete_notice_head',
             ...
             //define permission for School Accountant
        $permissionForAccountant = [
            'create_expenses',
            'list_expenses',
            'edit_expenses',
            'delete_expenses',
            ...
            'delete_notice_head',
             ...
             //define permission for School Librarian
        $permissionForLibrarian = [
            'create_expenses',
            'list_expenses',
            'edit_expenses',
            'delete_expenses',
            ...
            'delete_notice_head',
             ...
             //define permission for School Principal
        $permissionForPrincipal = [
            'create_expenses',
            'list_expenses',
            'edit_expenses',
            'delete_expenses',
            ...
            'delete_notice_head',
             ...
             //define permission for School Receptionist
        $permissionForReceptionist = [
            'create_expenses',
            'list_expenses',
            'edit_expenses',
            'delete_expenses',
        ...
        foreach ($listOfRoles as $roleName) {
            ...
            switch ($roleName) {
                ...
                case 'Teacher':
                    ...
                    break;
                case 'Accountant':
                    $role->givePermissionTo($permissionForAccountant);
                    break;
                case 'Librarian':
                    $role->givePermissionTo($permissionForLibrarian);
                    break;
                case 'Principal':
                    $role->givePermissionTo($permissionForPrincipal);
                    break;
                case 'Receptionist':
                    $role->givePermissionTo($permissionForReceptionist);
                     break;
